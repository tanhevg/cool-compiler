...
void ClassTable::install_basic_classes() {
   ...
   // curr_lineno  = 0;
    ...
    add_class(Int_class);
    add_class(IO_class);
    m_pInheritanceTable->add_node(Object_class, true);
    m_pInheritanceTable->add_node(Bool_class, false);
    m_pInheritanceTable->add_node(Str_class, false);
    m_pInheritanceTable->add_node(Int_class, false);
